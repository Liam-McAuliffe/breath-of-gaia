...
declare class SDK {
     ...
     */
    getElectricityInfo(metadata: types.GetElectricityInfoMetadataParam): Promise<FetchResponse<200, types.GetElectricityInfoResponse200>>;
    /**
     ...
     */
    getElectricityEstimation(metadata: types.GetElectricityEstimationMetadataParam): Promise<FetchResponse<200, types.GetElectricityEstimationResponse200>>;
    /**
     ...
     */
    getElectricitySolarEstimation(metadata: types.GetElectricitySolarEstimationMetadataParam): Promise<FetchResponse<200, types.GetElectricitySolarEstimationResponse200>>;
    /**
     ...
     */
    getElectricityCarbonFootprint(metadata: types.GetElectricityCarbonFootprintMetadataParam): Promise<FetchResponse<200, types.GetElectricityCarbonFootprintResponse200>>;
    /**
     ...
     */
    getElectricityInfoEsi(metadata?: types.GetElectricityInfoEsiMetadataParam): Promise<FetchResponse<200, types.GetElectricityInfoEsiResponse200>>;
    /**
     ...
     */
    getElectricityRetailRates(metadata: types.GetElectricityRetailRatesMetadataParam): Promise<FetchResponse<200, types.GetElectricityRetailRatesResponse200>>;
    /**
     ...
     */
    getElectricityGenerationRate(metadata: types.GetElectricityGenerationRateMetadataParam): Promise<FetchResponse<200, types.GetElectricityGenerationRateResponse200>>;
    /**
     ...
     */
    postElectricityRequestRate(body: types.PostElectricityRequestRateBodyParam): Promise<FetchResponse<200, types.PostElectricityRequestRateResponse200>>;
    /**
     ...
     */
    getElectricity(metadata: types.GetElectricityMetadataParam): Promise<FetchResponse<200, types.GetElectricityResponse200>>;
    /**
     ...
     */
    postElectricitySolarIncentives(body: types.PostElectricitySolarIncentivesBodyParam): Promise<FetchResponse<200, types.PostElectricitySolarIncentivesResponse200>>;
    /**
     * Offers
     *
     ...
     */
    getOffers(metadata: types.GetOffersMetadataParam): Promise<FetchResponse<200, types.GetOffersResponse200>>;
    /**
     * Marketplace Deeplink
     *
     * @throws FetchError<400, types.PostPlansLinkResponse400> Bad request
     */
    postPlansLink(body: types.PostPlansLinkBodyParam, metadata: types.PostPlansLinkMetadataParam): Promise<FetchResponse<200, types.PostPlansLinkResponse200>>;
    postPlansLink(metadata: types.PostPlansLinkMetadataParam): Promise<FetchResponse<200, types.PostPlansLinkResponse200>>;
    /**
    ...
    /**
     * This endpoint submits a deregulated electricity order to the chosen supplier. Before
     * making this call, the GET /form endpoint should already have been called.
     * Input query parameters for this endpoint include the plan_id from the previous step, the
     * user's IP address, and whether you'd like us to send a follow up email.
     * The request should also include a body containing the form as defined in the previous
     * GET request.
     *
     * Note: This API should use the enroll.wattbuy.com base URL rather than apis.wattbuy.com.
     * It is also recommended that you use QA (qaenroll.wattbuy.com) for development.
     *
     ...
     * @throws FetchError<400, types.PostFormResponse400> Bad request
     */
    postForm(body: types.PostFormBodyParam, metadata: types.PostFormMetadataParam): Promise<FetchResponse<200, types.PostFormResponse200>>;
    postForm(metadata: types.PostFormMetadataParam): Promise<FetchResponse<200, types.PostFormResponse200>>;
    /**
     ...
     */
    postCreditCheck(body: types.PostCreditCheckBodyParam, metadata: types.PostCreditCheckMetadataParam): Promise<FetchResponse<200, types.PostCreditCheckResponse200>>;
}
